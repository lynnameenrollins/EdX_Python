...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        shift = 0 #set initial shift to 0
        ...
        for i in range(26):
            ...
            shift += 1
            #print(" For shift " + str(i) + " , word count is " + str(wordCount)) 
                       
        tupleCiper = (bestShift, self.apply_shift(bestShift))
        return tupleCiper
...
dict = Message.build_shift_dict('hello people', 20)
...
def decrypt_story():
    ...
    decode = cipherText.decrypt_message()
    print('Story: ', decode[1])
